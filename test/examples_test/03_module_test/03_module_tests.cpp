...
TEST_CASE("Test number NOT in range 1 to 10 OR","Given number return true if NOT in range OR")
{
...
TEST_CASE("Test if char a consonant", "given char return true if consonant")
{
	...
	REQUIRE(is_char_a_consonant('b' == false);
}